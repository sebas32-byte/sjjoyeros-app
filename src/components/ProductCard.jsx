    ...
    <article className="group overflow-hidden rounded-[2rem] border border-white/10 bg-white/5 transition hover:-translate-y-1 hover:border-gold/40 hover:bg-white/10">
      ...
      <div className="space-y-4 p-5">
        ...
        <div className="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
          ...
          <div className="grid w-full gap-2 sm:flex sm:w-auto sm:grid-flow-col sm:items-center">
            <button onClick={() => addItem(product, 1)} className="w-full rounded-full bg-gold px-4 py-3 text-sm font-semibold text-deep-black transition hover:bg-[#f1c93f] sm:w-auto">Añadir</button>
